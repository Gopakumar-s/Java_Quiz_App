...
//=====================================OPTIONS==================================================//		
		...
		add (opt4);
		//=================================OPTIONS GROUP CREATED==================================================//		
		options = new ButtonGroup();
		options.add(opt1);
		options.add(opt2);
		options.add(opt3);
		options.add(opt4);
		//==================================BUTTONS > LIFE LINE > SUBMIT > NEXT ===================================//		
	...
	public void paint(Graphics g) {
		...
		if (timer>0) {
			g.drawString(time, 740, 400);
		}else {
			g.drawString("Times UP !!!", 740, 400);
		}
		timer--;
	...
	public void start(int count) {
		...
		opt2.setActionCommand(q[count][1]);
		opt3.setText(q[count][3]);
		opt3.setActionCommand(q[count][1]);
